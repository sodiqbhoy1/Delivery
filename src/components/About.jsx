...
const About = () => {
  return (
    <>
      <section id='about' className="bg-gray-100 py-10 px-5">
        {/* Top Section */}
        <main className="flex flex-col md:flex-row items-center justify-between mb-10">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h2 className="text-2xl md:text-[35px] font-bold mb-4">Find Out A Little More About Us</h2>
        ...
        {/* Bottom Section */}
        <main className="flex flex-col md:flex-row items-center justify-between m-10">
          {/* Left - Text */}
          <div className="md:w-1/2 text-center md:text-left mb-6 md:mb-0">
            <h2 className="text-2xl md:text-[35px] font-bold mb-4">Your Safety Is Important</h2>
            <p className="text-gray-500 text-lg">
