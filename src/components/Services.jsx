...
const Services = () => {
  return (
    <>
      ...
      <div className="bg-gray-100 py-10 my-2 rounded">
  <h2 className="font-bold text-[40px] text-center my-8">Some Services We Offer</h2>
  ...
  <section className="flex flex-col md:flex-row items-center justify-between my-10 px-5">
    ...
    <div className="w-full md:w-1/2 text-center md:text-left">
      <h2 className="text-[35px] font-bold my-4 md:my-8">Watch Your Delivery At Any Time</h2>
